  ...
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <div style="display:flex;gap:1rem;margin-top:.5rem">
        <a href="https://instagram.com/CountryBistroJuja" id="sf-ig" target="_blank" style="color:rgba(255,255,255,.5);font-size:.82rem;text-decoration:none;transition:color .2s;display:inline-flex;align-items:center;gap:5px" onmouseenter="this.style.color='#C9963A'" onmouseleave="this.style.color='rgba(255,255,255,.5)'"><span style="opacity:.7"><svg style="width:14px;height:14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></span>Instagram</a>
        <a href="#" id="sf-fb" target="_blank" style="color:rgba(255,255,255,.5);font-size:.82rem;text-decoration:none;transition:color .2s;display:inline-flex;align-items:center;gap:5px" onmouseenter="this.style.color='#C9963A'" onmouseleave="this.style.color='rgba(255,255,255,.5)'"><span style="opacity:.7"><svg style="width:14px;height:14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg></span>Facebook</a>
        <a href="https://wa.me/254768262450" id="sf-wa" target="_blank" style="color:rgba(255,255,255,.5);font-size:.82rem;text-decoration:none;transition:color .2s;display:inline-flex;align-items:center;gap:5px" onmouseenter="this.style.color='#C9963A'" onmouseleave="this.style.color='rgba(255,255,255,.5)'"><span style="opacity:.7"><svg style="width:14px;height:14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg></span>WhatsApp</a>
      </div>
    </div>
    <div>
    ...
    <div>
      ...
      <div class="footer-contact-item"><span><svg style="width:14px;height:14px;flex-shrink:0;margin-top:2px;color:var(--gold)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></span><span>Ground Floor, Juja City Mall</span></div>
      <div class="footer-contact-item"><span><svg style="width:14px;height:14px;flex-shrink:0;margin-top:2px;color:var(--gold)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6 6l1-1a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span><span id="sf-phone1">+254 768 262450</span></div>
      <div class="footer-contact-item"><span><svg style="width:14px;height:14px;flex-shrink:0;margin-top:2px;color:var(--gold)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6 6l1-1a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span><span id="sf-phone2">+254 707 356971</span></div>
      <div class="footer-contact-item"><span><svg style="width:14px;height:14px;flex-shrink:0;margin-top:2px;color:var(--gold)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></span><span id="sf-email">info@countrybistro.co.ke</span></div>
      <div class="footer-contact-item"><span><svg style="width:14px;height:14px;flex-shrink:0;margin-top:2px;color:var(--gold)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></span><span>countrybistro.co.ke</span></div>
    </div>
  </div>
